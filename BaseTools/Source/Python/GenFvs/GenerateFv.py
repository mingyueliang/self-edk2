...
def GenFvApi():
    Options = MyOptionsParser()
    GenFvObject = GenerateFvFile(Options)
    ...
    EdkLogger.info("The used Fv Size, %s = %s" % (
        EFI_FV_TAKEN_SIZE_STRING, GenFvObject.FvTakenSize))
...
class GenerateFvFile(object):
    ...
    def GenerateFvImage(self):
        ...
        if not self.OutFileName:
            EdkLogger.error("GenFvs", OPTION_MISSING,
    ...
    def ParseFvInf(self):
        ...
        for Index in range(len(mFvbAlignmentName)):
            Alignment = Attributes.get(mFvbAlignmentName[Index])
            if Alignment != None:
        ...
        if AlignmentFlag != None:
            if AlignmentFlag[0] == TRUE_STRING or AlignmentFlag[
                ...
                0] != ZERO_STRING:
                EdkLogger.error('GenFvs', PARAMETER_INVALID,
        ...
        if flag == 0:
            EdkLogger.error("GenFvs", PARAMETER_MISSING,
    ...
    def CalculateFvSize(self):
        ...
        if self.FvDataInfo.Size == 0:
            ...
            self.FvDataInfo.Size = self.FvDataInfo.FvBlocks[0].NumBlocks * \
                                   self.FvDataInfo.FvBlocks[
                                       0].Length
            self.FvDataInfo.FvBlocks[1].NumBlocks = 0
            self.FvDataInfo.FvBlocks[1].Length = 0
    ...
    @staticmethod
    def ReadFfsAlignment(FfsHeader):
    ...
    def AddFile(self, Index):
        ...
        try:
            ...
            EdkLogger.error("GenFvs", FILE_OPEN_FAILURE,
    ...
    def FindCorePeSection(self, ImageBuffer: bytes, FileType: int):
        ...
        while True:
            ...
            while True:
                ...
                Pe32Section = self.FindCorePeSection(ImageBuffer[
    ...
    def AddPadFile(self, DataAlignment: int, NextFfsSize: int, FvExtHeader=None,
        ...
        PadFileHeader = self.UpdateFfsFileState(PadFileHeader, FvHeader)
