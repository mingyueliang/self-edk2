...
# def EfiCompress(CompressBuffer):
#     """
#     compress buffer.
#     return: Compressed content.
#     """
#     return HuffManTree.encode(CompressBuffer)
...
def compress(inputfilename, outputfilename):
    ...
    # 4. 步
    # 4.1. 保存叶节点的骤2中获取到的 每个值出现的频率的信息个数
...
def decompress(buffer, outputfilename):
    """
    解压缩文件，参数有
