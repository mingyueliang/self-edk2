...
FfsFileType = {
    ...
    0x0A: "EFI_FV_FILETYPE_SMM",
    0x0B: "EFI_FV_FILETYPE_FIRMWARE_VOLUME_IMAGE",
    0x0C: "EFI_FV_FILETYPE_COMBINED_SMM_DXE",
    0x0D: "EFI_FV_FILETYPE_SMM_CORE",
    0x0E: "EFI_FV_FILETYPE_MM_STANDALONE",
    0x0F: "EFI_FV_FILETYPE_MM_CORE_STANDALONE",
    0xc0: "EFI_FV_FILETYPE_OEM_MIN",
    0xdf: "EFI_FV_FILETYPE_OEM_MAX",
    0xe0: "EFI_FV_FILETYPE_DEBUG_MIN",
    0xef: "EFI_FV_FILETYPE_DEBUG_MAX",
    # 0xf0: "EFI_FV_FILETYPE_FFS_MIN",
    0xff: "EFI_FV_FILETYPE_FFS_MAX",
...
EFI_FILE_DATA_VALID = 0x03
EFI_FILE_MARKED_FOR_UPDATE = 0x04
EFI_FILE_DELETED = 0x05
EFI_FILE_HEADER_INVALID = 0x06
