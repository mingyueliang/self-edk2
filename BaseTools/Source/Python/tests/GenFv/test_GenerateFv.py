...
class TestGenFv:
    ...
    def test_GenerateFvImage(self):
        ...
        InfFiles = [
            ...
            #           debug=None, dump=False, quiet=False, verbose=False,
            #           version=False),
            # Namespace(Address=None, AddressFile="FV/FSP-S.inf", BlockSize=None,
            #           CapFlag=None,
            #           CapGUid=None, CapHeadSize=None, CapOEMFlag=None,
            #           FfsFile=None,
            #           FileTakeSize=None, ForceRebase=None, FvNameGuid=None,
            #           Guid=None, InFileName='FV/FSP-S-i.inf', Map=None,
            #           NumberBlock=None, OutFileName='FV/FSP-S-test.FV',
            #           capsule=False,
            #           debug=None, dump=False, quiet=False, verbose=False,
            #           version=False),
            Namespace(Address=None, AddressFile="FV/FSP-I_COMPACT.inf", BlockSize=None,
                      CapFlag=None,
                      CapGUid=None, CapHeadSize=None, CapOEMFlag=None,
                      FfsFile=None,
                      FileTakeSize=None, ForceRebase=None, FvNameGuid=None,
                      Guid=None, InFileName='FV/FSP-I_COMPACT-i.inf', Map=None,
                      NumberBlock=None, OutFileName='FV/FSP-I_COMPACT-test.FV',
                      capsule=False,
                      debug=None, dump=False, quiet=False, verbose=False,
                      version=False),
        ...
        OutFiles = [
            ...
            ["FV/FSP-S.Fv", "FV/FSP-S.Fv.map", "FV/FSP-S.Fv.txt"],
            # ["FV/FSP-I_COMPACT.Fv", "FV/FSP-I_COMPACT.Fv.map", "FV/FSP-I_COMPACT.Fv.txt"],
        ]
